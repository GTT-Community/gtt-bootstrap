...
| File | Contains | Loads |
|---|---|---|
| `SESSION.md` | Snapshot of adapter/freeze/backlog-focus/proposals/change-request/ADRs/GTTGuard state, regenerated by `gtt-status.sh`. Derived — never hand-edited | never |
