...
- `gtt/` existente (y, dentro, `INDEX.md`, `CHANGE-REQUEST.md`, `GTT-COMPLETION.md`, `backlog.md`)
- `.claude/` existente
- `.kiro/` existente
...
GTT, `AGENTS.md` y `SOURCE-BRIEF.*` pertenecen a la raíz del proyecto — ver
*Higiene del workspace* en `README-GTT.md`. Todo lo demás que posee GTT,
incluyendo este archivo, se genera directamente bajo `gtt/`, nunca en la
raíz.
...
12. Buscar Epics/Stories definidas (documento de requisitos, issue tracker, o conversación previa). Si existen, reconciliarlas en `gtt/backlog.md`; si no existe ninguna, decirlo explícitamente en vez de inventarlas.
...
- si `gtt/backlog.md` está definido y reconciliado con las Epics/Stories conocidas
...
- [ ] `.gitignore` combinado.
- [ ] Contexto poblado.
- [ ] `gtt/backlog.md` presente; Epics/Stories conocidas reconciliadas o explícitamente ausentes.
